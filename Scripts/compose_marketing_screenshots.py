...
SLIDES = [
    Slide(
        source="01-lineup.png",
        output="01-your-lineup.png",
        index=0,
        total=5,
        eyebrow="LINEUP",
        headline="Your lineup.",
        support="Starters, salary, and the week ahead —\nready before kickoff.",
    ),
    Slide(
        source="02-matchup.png",
        output="02-your-matchups.png",
        index=1,
        total=5,
        eyebrow="MATCHUP",
        headline="Your matchups.",
        support="Swipe to see scores and starters\nside by side with your opponent.",
    ),
    Slide(
        source="03-league.png",
        output="03-your-leagues.png",
        index=2,
        total=5,
        eyebrow="LEAGUE",
    ...
    Slide(
        source="04-desk.png",
        output="04-your-front-office.png",
        index=3,
        total=5,
        eyebrow="DESK",
        headline="Your front office.",
